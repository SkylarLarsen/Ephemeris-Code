...
print(RA_ECM_output) #this comes out to -0.004315253268850393, should be -0.00822898
...
print(Dec_ECM_output) #this comes out to 0.11376857350496107, should be 0.0900489
